package com.bupt.lams.service.task;
...
public interface TaskManagerService {
     ...
     * 查询未签收任务（暂不支持分页）
     *
     * @param taskQueryDto 查询对象（支持按用户账号及业务Key精确查询）
     * @return 待办任务集合
     */
     ...
     * 查询已签收任务（暂不支持分页）
     *
     * @param taskQueryDto 查询对象（只支持按账号查询）
     * @return 已签收任务集合
     */
     ...
     * 查询任务表单信息
     *
     * @param taskQueryDto 查询对象（taskId,userId)
     * @return 任务表单信息
     */
